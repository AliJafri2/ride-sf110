...
public class JVCBootstrapGeneratorEvoSuiteTest {
  ...
  //Test case number: 2
  /*
   * Originally tested that EvoSuite's Sandbox security manager blocked file writes.
   * Without the EvoSuite sandbox, this test is not meaningful — removed.
   * See docs/PATCHLOG.md for details.
   */
